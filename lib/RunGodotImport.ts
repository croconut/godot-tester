...
function addRebuilderSceneToProjectAddonFolder(input: Readonly<ActionInput>) {
...
function removeRebuilderSceneFromProjectAddonFolder(input: Readonly<ActionInput>) {
...
function runGodotImport(input: Readonly<ActionInput>, exePath: string) {
